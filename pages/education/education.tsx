    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          <a href="http://localhost:3000/education/sex" className={styles.card}>
            <h2 className={styles.cardtext}>Sex</h2>
          </a>

          <a
            href="http://localhost:3000/education/sexual-health"
          ...
          <a
            href="http://localhost:3000/education/masturbation&porn"
            className={styles.card}
          >
          ...
          <a
            href="http://localhost:3000/education/contraception"
            className={styles.card}
          >
            <h2 className={styles.cardtext}>Contraception</h2>
          </a>
          <a
            href="http://localhost:3000/education/consent"
            className={styles.card}
          >
            <h2 className={styles.cardtext}>Consent</h2>
          </a>
          <a
            href="http://localhost:3000/education/pregnancy"
            className={styles.card}
          >
            <h2 className={styles.cardtext}>Pregnancy</h2>
          </a>
          <a
            href="http://localhost:3000/education/relationships"
            className={styles.card}
          >
